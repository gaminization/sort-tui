...
class RedBlackTreeSort(SortAlgorithm):
    name = "Red-Black Tree Sort"
    category = "CATEGORY"  # replaced by init
    time_complexity = "O(n log n)"
    space_complexity = "O(n)"
    stable = True
    description = "Sorts using a Red-Black Tree."
    
    def get_invariant(self) -> str:
        return "Every path from root to leaf has the same number of black nodes; red nodes never have red children."
