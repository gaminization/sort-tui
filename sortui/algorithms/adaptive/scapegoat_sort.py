...
class ScapegoatSort(SortAlgorithm):
    name = "Scapegoat Sort"
    category = "CATEGORY"  # replaced by init
    time_complexity = "O(n log n)"
    space_complexity = "O(log n)"
    stable = False
    description = "Sorts using an alpha-balanced Scapegoat Tree."
    
    def get_invariant(self) -> str:
        return "The tree is alpha-balanced (alpha=0.7): no subtree is more than alpha * parent_size — rebuilds enforce this."
