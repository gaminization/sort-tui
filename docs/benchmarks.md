...
**Execution Command:**
```bash
sort-tui --benchmark bubble insertion selection cocktail_shaker shellsort comb merge quicksort heapsort timsort introsort dual_pivot_quicksort counting radix_lsd radix_msd bucket pdqsort adaptive_merge --size 500 --seed 42
```
...
> [!TIP]
> Try running this yourself! `sort-tui --benchmark timsort --distribution nearly_sorted --size 500`
